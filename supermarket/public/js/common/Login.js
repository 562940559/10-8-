	...
	<div class="from-login">
		...
		<form>
			...
			<div class="form-group" style="margin-bottom:0px">
			    <label for="loginCaptcha" style="float:left;margin-right:18px;margin-top:10px">验证码:</label>
			    <div class="input-group" style="width: 200px;float:left;margin-top:5px">
				...
				<div class="captcha-container" style="margin-top:10px"></div>
			</div>
			<div class="clearfix"></div>
			<a href="javascript:;" id="login_button">登录</a>
			<a href="javascript:;" id="re_button">重置</a>
			<a href="javascript:;" class="btn-login">haha</a>
		</form>
	</div>
	`;
